...
def verify(img1_path, img2_path='', model_name='VGG-Face', distance_metric='cosine',
    ...
    if model_name == 'Ensemble':
        model_names = ["VGG-Face", "Facenet", "OpenFace", "DeepFace", "ArcFace"]
        ...
        if type(instance) == list and len(instance) >= 2:
            ...
            if model_name == 'Ensemble':
                ...
                resp_obj = {
                    ...
                    , "model": ["VGG-Face", "Facenet", "OpenFace", "DeepFace", "ArcFace"]
...
def analyze(img_path, actions=['emotion', 'age', 'gender', 'race']
    ...
    global_pbar = range(0, len(img_paths))
...
def find(img_path, db_path, model_name='VGG-Face', distance_metric='cosine', model=None, enforce_detection=True,
    ...
    Returns: This function returns pandas data frame. If a list of images is passed to img_path, then it will return list of pandas data frame.
    """
